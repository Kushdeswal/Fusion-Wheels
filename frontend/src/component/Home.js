    ...
    <>
      ...
      <div className="container mx-auto  h-96 px-5 " style={{ maxWidth: "1600px" }} >
        <Carousel responsive={responsive} autoPlay infinite={true} autoPlaySpeed={2000} className="h-full w-full">
          <div><img src="https://as2.ftcdn.net/v2/jpg/06/41/96/25/1000_F_641962526_qcc8Mend5FKDQXdnmfoFrl9LyjAELKQ5.jpg" alt="poster" className="h-full w-full" /></div>
          <div><img src="https://as2.ftcdn.net/v2/jpg/06/70/33/33/1000_F_670333367_d7cYnP5xTqL9AcKpuMg1Pei4843uIfcb.jpg" alt="poster" className="h-full w-full" /></div>
          <div><img src="https://as1.ftcdn.net/v2/jpg/06/82/18/48/1000_F_682184879_tzM0g2KLGUWCR2k3T4UgtNw8jsbLdkSg.jpg" alt="poster" className="h-full w-full" /></div>
        </Carousel>
