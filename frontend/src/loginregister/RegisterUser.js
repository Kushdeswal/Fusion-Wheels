...
function RegisterUser({settoggle,setshow}) {
    ...
    const { values, errors, touched, handleBlur, handleChange, handleSubmit } = useFormik({
        ...
        onSubmit: (values) => {
            // "https://e-commerce-backend-vja4.onrender.com/user/newuser"
        ...
        <div class="rounded-xl bg-gray-800 bg-opacity-50 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8 relative">
            ...
            <div class="text-white">
                <div class="mb-8 flex flex-col items-center">
                    ...
                    <h1 class="mb-2 text-2xl"><FontAwesomeIcon icon={faBagShopping} /> FUSION WHEELS</h1>
                    <span class="text-gray-300">Welcome To FUSION WHEELS</span>
                </div>
                <form onSubmit={handleSubmit}>
                    ...
                    <p className="cursor-pointer" onClick={() => settoggle(true)}>Do you have an account <span className="text-yellow-300">"LOGIN ACCOUNT"</span>  </p>
                </form>
            </div>
        </div>
