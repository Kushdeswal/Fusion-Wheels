        ...
        <div className="rounded-xl bg-gray-800 bg-opacity-50 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8 relative">
            ...
            <div className="text-white">
                <div className="mb-8 flex flex-col items-center">
                    ...
                    <h1 className="mb-2 text-2xl"><FontAwesomeIcon icon={faBagShopping} /> FUSION WHEELS</h1>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <p className="cursor-pointer" onClick={() => settoggle(false)}>Don't have an account <span className="text-yellow-300">"CREATE ACCOUNT "</span> </p>
                </form>
            </div>
        </div>
